...
<div class="week_cal" id="month_viewcal">
    <table class="wp-calendar wdn_responsive_table">
        <caption>
            <span><a href="<?php echo $context->getPreviousURL(); ?>" id="prev_week"><span class="eventicon-angle-circled-left" aria-hidden="true"></span><span class="wdn-text-hidden">View events for week <?php echo $prev->format('W'); ?></span></a></span>
            ...
            <span><a href="<?php echo $context->getNextURL(); ?>" id="next_week"><span class="eventicon-angle-circled-right" aria-hidden="true"></span><span class="wdn-text-hidden">View events for week <?php echo $next->format('W'); ?></span></a></span>
        </caption>
        <thead>
        <?php
        $weekdays = array(
