                            ...
                            <div class="dcf-popup dcf-d-inline" data-point="true">
                                <button class="dcf-btn dcf-btn-tertiary dcf-btn-popup dcf-p-0" type="button">
                                    ...
                                    >
                                        ...
                                        <path d="M14.5,19H12v-8.5c0-0.276-0.224-0.5-0.5-0.5h-2
                                            ...
                                            C8.224,19,8,19.224,8,19.5 S8.224,20,8.5,20h6c0.276,0,
                                            0.5-0.224,0.5-0.5S14.776,19,14.5,19z"></path>
                                ...
                                >
                                    <p class="dcf-m-0 dcf-regular">
                                        ...
                                        Saved locations will be included in the dropdown above.
                                    </p>
                                </div>
                            </div>
                        </label>
                        ...
                        <label for="location-save-calendar">
                            ...
                            <div class="dcf-popup dcf-d-inline" data-point="true">
                                <button class="dcf-btn dcf-btn-tertiary dcf-btn-popup dcf-p-0" type="button">
                                    ...
                                    >
                                        <path d="M11.5,1C5.159,1,0,6.159,0,12.5C0,18.841,5.159,24,11.5,24
                                            S23,18.841,23,12.5C23,6.159,17.841,1,11.5,1z
                                            M11.5,23 C5.71,23,1,18.29,1,12.5 C1,6.71,5.71,2,11.5,2S22,
                                            6.71,22,12.5C22,18.29,17.29,23,11.5,23z"></path>
                                        <path d="M14.5,19H12v-8.5c0-0.276-0.224-0.5-0.5-0.5h-2
                                            C9.224,10,9,10.224,9,10.5S9.224,11,9.5,11H11v8H8.5
                                            C8.224,19,8,19.224,8,19.5 S8.224,20,8.5,20h6c0.276,0,
                                            0.5-0.224,0.5-0.5S14.776,19,14.5,19z"></path>
                                ...
                                >
                                    <p class="dcf-m-0 dcf-regular">
                                        ...
                                        this location easily. Saved locations will be included in the dropdown above.
                                    </p>
                                </div>
                            </div>
                        </label>
                            ...
                            <div class="dcf-popup dcf-d-inline" data-point="true">
                                ...
                                >
                                    <p class="dcf-m-0 dcf-regular">
                                        ...
                                        location easily. Saved virtual locations will be included in the dropdown above.
                                    </p>
                                </div>
                            </div>
                        </label>
                            ...
                            <div class="dcf-popup dcf-d-inline" data-point="true">
                                <button class="dcf-btn dcf-btn-tertiary dcf-btn-popup dcf-p-0" type="button">
                                    ...
                                    >
                                        <path d="M11.5,1C5.159,1,0,6.159,0,12.5C0,18.841,5.159,24,11.5,24
                                            S23,18.841,23,12.5C23,6.159,17.841,1,11.5,1z M11.5,23
                                            C5.71,23,1,18.29,1,12.5 C1,6.71,5.71,2,11.5,2
                                            S22,6.71,22,12.5C22,18.29,17.29,23,11.5,23z"></path>
                                        <path d="M14.5,19H12v-8.5c0-0.276-0.224-0.5-0.5-0.5h-2
                                            C9.224,10,9,10.224,9,10.5S9.224,11,9.5,11H11v8H8.5
                                            C8.224,19,8,19.224,8,19.5 S8.224,20,8.5,20h6c0.276,0,
                                            0.5-0.224,0.5-0.5S14.776,19,14.5,19z"></path>
