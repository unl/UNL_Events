        ...
        <div class="dcf-grid dcf-col-gap-vw">
            ...
            <div class="dcf-col-100% dcf-col-67%-start@md">
                ...
                <fieldset>
                    ...
                    <div class="dcf-form-group">
                        <label class="dcf-label dcf-mt-2" for="timezone">Time Zone <small class="dcf-required">Required</small></label>
              ...
              <fieldset>
                  ...
                  <div class="details">
                      ...
                      <fieldset id="send_to_main">
                          <legend>Consider for Main <abbr title="University of Nebraska–Lincoln"">UNL</abbr> Calendar <small class="dcf-required">Required</small></legend>
                          <div class="dcf-input-radio">
