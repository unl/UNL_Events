...
<div class="dcf-tabs dcf-tabs-responsive dcf-mt-6 dcf-mb-9">
    <ul class="dcf-tabs-list dcf-list-bare dcf-mb-0" role="tablist">
        <li class="dcf-tabs-list-item dcf-mb-0 <?php if ($context->tab == 'pending') echo 'selected'; ?>" role="presentation"><a class="dcf-tab dcf-d-block" role="tab" <?php if ($context->tab == 'pending') { echo 'aria-selected="true"'; } ?> href="<?php echo ($context->tab == 'pending' ? '#pending' : '?tab=pending'); ?>">Pending (<?php echo count($categorized_events['pending']); ?>)</a></li>
        <li class="dcf-tabs-list-item dcf-mb-0 <?php if ($context->tab == 'upcoming') echo 'selected'; ?>" role="presentation"><a class="dcf-tab dcf-d-block" role="tab" <?php if ($context->tab == 'upcoming') { echo 'aria-selected="true"'; } ?> href="<?php echo ($context->tab == 'upcoming' ? '#upcoming' : '?tab=upcoming'); ?>">Upcoming (<?php echo count($categorized_events['posted']); ?>)</a></li>
        <li class="dcf-tabs-list-item dcf-mb-0 <?php if ($context->tab == 'past') echo 'selected'; ?>" role="presentation"><a class="dcf-tab dcf-d-block" role="tab" <?php if ($context->tab == 'past') { echo 'aria-selected="true"'; } ?> href="<?php echo ($context->tab == 'past' ? '#past' : '?tab=past'); ?>">Past (<?php echo count($categorized_events['archived']); ?>)</a></li>
    </ul>
