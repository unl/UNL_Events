<?php if (isset($context->event->subtitle)): ?><header><?php endif; ?>
    <h2>
        <a class="url summary dcf-txt-decor-none" href="<?php echo $frontend->getEventURL($context->getRawObject()) ?>"><?php echo $savvy->dbStringtoHtml($context->event->displayTitle($context)) ?></a>
    </h2>
