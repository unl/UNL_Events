...
if (isset($context->eventdatetime->location_id) && $location !== false):
    ...
    $directions = !empty($context->eventdatetime->directions) ?
        $context->eventdatetime->directions : $locationDirections;
    $location_additional_info = !empty($context->eventdatetime->location_additionalpublicinfo) ?
        $context->eventdatetime->location_additionalpublicinfo : $locationAdditional;
    ?>
        ...
        <div class="location">
            ...
            <span>
                ...
                <?php if (isset($location->streetaddress1)): ?>
                    <div class="adr">
                        <span class="street-address"><?php
                            echo $savvy->dbStringtoHtml($location->streetaddress1 . "\n" . $location->streetaddress2)
                        ?></span>
                ...
                <?php if (!empty($location_additional_info)): ?>
                    <div class="additionalinfo">Additional Info: <?php
                        echo $savvy->dbStringtoHtml($location_additional_info)
                    ?></div>
                <?php endif ?>
            </span>
        </div>
    ...
    <div class="location">
        ...
        <span>
            ...
            <?php if (isset($webcast_additional_info) && !empty($webcast_additional_info)): ?>
                <div class="additionalinfo">Additional Info: <?php
                    echo $savvy->dbStringtoHtml($webcast_additional_info)
                ?></div>
            <?php endif ?>
        </span>
    </div>
