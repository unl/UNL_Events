...
<?php if (isset($location->mapurl) && filter_var($context->mapurl, FILTER_VALIDATE_URL)): ?>
    <a class="mapurl" href="<?php echo $location->mapurl ?>"><?php echo $location->name; ?></a>
<?php elseif (isset($location->webpageurl) && filter_var($context->webpageurl, FILTER_VALIDATE_URL)): ?>
