	...
	foreach ($context as $eventinstance) {
		...
		?>
            <li class="unl-event-teaser">
                <header class="unl-event-title"><h3 class="dcf-mb-0 dcf-lh-3 dcf-bold dcf-txt-h6 unl-lh-crop"><a class="dcf-txt-decor-hover unl-darker-gray" href="<?php echo $url; ?>"><?php echo $event->title; ?></a></h3><?php echo $subTitle; ?><?php echo $location; ?></header>
