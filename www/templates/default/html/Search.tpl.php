    ...
    <section class="dcf-col-100% dcf-col-33%-start@md">
        <h2 class="results clear-top">
            ...
            if ($dt = $context->getSearchTimestamp()) {
                ...
                echo '<span class="dcf-subhead">'.$context->count().' search results for </span><a class="permalink" href="'.$context->getURL().'"> "Any" </a>';
            } else {
        ...
        <form class="dcf-form dcf-mt-5">
            ...
            <fieldset>
                ...
                <div class="dcf-form-group">
                    ...
                    <select class="dcf-w-100%" id="type" name="audience">
                        <option
                ...
                <input class="dcf-btn dcf-btn-primary" type="submit" value="Filter" />
            </fieldset>
