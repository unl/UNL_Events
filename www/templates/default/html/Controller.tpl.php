                                ...
                                <div class="submit-search">
                                    ...
                                    <form class="dcf-form" id="event_search" method="get" action="' . $frontend->getCalendarURL() . 'search/" role="search">
                                        ...
                                        <div class="dcf-input-group">
                                            <input type="text" name="q" id="searchinput" placeholder="e.g., Monday, tomorrow" value="' . ((isset($context->options['q']) && strpos($context->output->getURL(), 'audience') !== 0)?$context->options['q']:'') . '"/>
